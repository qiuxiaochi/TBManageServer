 ...
 * 添加技术信息
 */
public class AddJishuHandler implements Handler<RoutingContext>{

private IJsMgService service;
	
	public AddJishuHandler(IJsMgService userService) {
	...
	public void handle(RoutingContext ctx) {
		...
		FixedThreadPool.threadPool.submit(new Runnable() {
			...
			public void run() {
				...
				String rString = service.addJishu(keFu, jishu);
