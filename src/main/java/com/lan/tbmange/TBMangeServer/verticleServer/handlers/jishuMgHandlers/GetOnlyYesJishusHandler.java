 ...
 * 获得只有好评的技术
 */
public class GetOnlyYesJishusHandler implements Handler<RoutingContext> {

	private IJsMgService service;

	public GetOnlyYesJishusHandler(IJsMgService userService) {
	...
	public void handle(RoutingContext ctx) {
		...
		FixedThreadPool.threadPool.submit(new Runnable() {
			...
			public void run() {
				...
				Vector<Jishu> jishus = service.getOnlyYesJishus();
